...
import cn.weiyf.dleventbus.EventBusException;
...
public abstract class AbstractSubscriberInfo implements SubscriberInfo {
    ...
    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType, int tag) {
        return createSubscriberMethod(methodName, eventType, ThreadMode.POSTING, tag, 0, false);
    }

    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType, ThreadMode threadMode, int tag) {
        return createSubscriberMethod(methodName, eventType, threadMode, tag, 0, false);
    }
    ...
    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType, ThreadMode threadMode,
        ...
        try {
            ...
            return new SubscriberMethod(method, eventType, threadMode, tag, priority, sticky);
